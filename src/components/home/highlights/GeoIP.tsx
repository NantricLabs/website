            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Compare results from leading GeoIP databases in one view</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">See location discrepancies visually plotted on a world map</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Determine which provider offers the most precise geolocation data</p>
                </div>
              </div>
            </div>
                ...
                <div className="relative w-full h-full flex flex-col">
                  ...
                  <div className="bg-white/80 rounded-lg border border-gray-200 p-4 mb-4 backdrop-blur-sm">
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        <div className="text-sm font-medium text-gray-900">IP Geolocation Comparison</div>
                        <div className="text-xs text-gray-500">Compare multiple providers at once</div>
                      </div>
                    </div>

                    <a href="https://ip.nantric.com" target="_blank" className="flex bg-gray-50 rounded-md border border-gray-200 p-2 mb-4">
                      <input
                        type="text"
                        readOnly
                        value="8.8.8.8"
                  ...
                  <div className="flex-1 bg-white/80 rounded-lg border border-gray-200 p-4 relative overflow-hidden backdrop-blur-sm">
                    ...
                    <Image src={MapAsset} alt="World Map" className="w-full h-full object-cover rounded-lg opacity-70" />
