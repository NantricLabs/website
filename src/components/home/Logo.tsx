        ...
        <div className="flex items-center gap-3">
            <div className="relative">
                <div className="w-10 h-10 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 flex items-center justify-center overflow-hidden">
                    ...
                    <span className="font-bold text-xl relative z-10">N</span>
                </div>
                <div className="absolute -inset-1 bg-teal-500/20 rounded-full blur-md -z-10 opacity-50"></div>
            </div>
            <h1 className="text-xl font-medium tracking-tight">NANTRIC</h1>
        </div>
    );
};