				...
				<div className="flex flex-col lg:flex-row gap-16 mb-16">
					<div className="lg:w-1/3">
						...
						<p className="text-gray-600 mb-8 leading-relaxed">
							Transforming ideas into exceptional digital experiences with custom software
							development, SaaS products, and reliable hosting solutions.
						</p>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-20 lg:w-2/3">
						<div>
							...
							<ul className="space-y-4">
								<li>
									<Link href="/wip" className="text-gray-600 hover:text-teal-600 transition-colors">
										Custom Software
									</Link>
								</li>
								<li>
