...
import { ArrowRight, Cloud, Code, Globe, Server } from "lucide-react"
					...
					<div className="absolute inset-0 flex items-center justify-between px-10">
						...
						<div className="relative">
							<motion.div
								...
								transition={{
									duration: 2,
									repeat: deploymentStarted && !deploymentComplete ? Infinity : 0,
								}}
							>
						...
						<svg width="80" height="2" className="absolute left-24 top-1/2 -translate-y-1/2">
							...
							{deploymentStarted && (
								<motion.circle r="3" fill="#14b8a6" initial="hidden" animate="visible" />
							)}
						</svg>
						...
						<div className="relative">
							...
							>
								<Server
									size={24}
									className={`${deploymentComplete ? "text-teal-600" : "text-gray-400"}`}
								/>
							</motion.div>
						...
						<svg
							width="80"
							height="2"
							className="absolute left-[calc(50%-40px)] top-1/2 -translate-y-1/2"
						>
							<motion.path
								d="M0 1 L80 1"
