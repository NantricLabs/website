...
export default App`
    ...
    return (
        <div className="h-full w-full flex flex-col">
            ...
            <div className="flex-1 rounded-xl border border-white/10 bg-black/60 mb-4 overflow-hidden flex flex-col">
                <div className="flex items-center bg-white/5 px-4 py-2 border-b border-white/10">
                    ...
                    <div className="ml-4 text-xs font-mono text-white/60">App.jsx</div>
                ...
                <div className="p-4 font-mono text-xs overflow-auto h-full flex-1 whitespace-pre">
                    <code className="text-white/80">
                        ...
                        <motion.span
                            ...
                            className="inline-block w-2 h-4 bg-teal-400 ml-[1px]"
                        ></motion.span>
                    </code>
                </div>
                ...
                <AnimatePresence>
                    {codeComplete && (
                        <motion.div
                            ...
                            className="bg-teal-500/10 text-teal-400 text-xs p-2 font-mono border-t border-teal-500/20 flex items-center"
                        >
                            ...
                            {!deploymentStarted && (
                                <motion.button
                                    ...
                                    className="ml-auto bg-teal-500 text-black rounded px-2 py-1 text-xs flex items-center gap-1"
            ...
            <div className="h-48 rounded-xl border border-white/10 bg-black/60 relative overflow-hidden">
                <div className="absolute inset-0">
                    ...
                    <div className="absolute inset-0 flex items-center justify-between px-10">
                        ...
                        <div className="relative">
                            <motion.div
                                className="w-14 h-14 rounded-lg border border-white/10 bg-white/5 flex items-center justify-center"
                                animate={{
                            ...
                            <div className="mt-2 text-xs text-center text-white/60">Code</div>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            >
                                <Server size={24} className={`${deploymentComplete ? "text-teal-400" : "text-white/40"}`} />
                            </motion.div>
                            <div className="mt-2 text-xs text-center text-white/60">Server</div>
                        ...
                        <div className="relative">
                            <motion.div
                                ...
                                animate={deploymentComplete ? "pulse" : "idle"}
                            >
                                <Cloud size={24} className={`${deploymentComplete ? "text-teal-400" : "text-white/40"}`} />
                            </motion.div>
                            <div className="mt-2 text-xs text-center text-white/60">Cloud</div>
                        ...
                        <div className="relative">
                            ...
                            >
                                <Globe size={24} className={`${showUsers ? "text-teal-400" : "text-white/40"}`} />
                            </motion.div>
                            <div className="mt-2 text-xs text-center text-white/60">Users</div>
                            ...
                            {showUsers && (
                                <>
                                    <motion.div
                                        className="absolute -top-3 -right-3 w-6 h-6 rounded-full bg-white/5 border border-white/10 flex items-center justify-center"
                                        initial={{ scale: 0 }}
                                        animate={{ scale: 1 }}
                                    ...
                                    <motion.div
                                        className="absolute -bottom-3 -right-2 w-5 h-5 rounded-full bg-white/5 border border-white/10 flex items-center justify-center"
                                        initial={{ scale: 0 }}
                                        animate={{ scale: 1 }}
                                    ...
                                    <motion.div
                                        className="absolute -bottom-2 -left-3 w-5 h-5 rounded-full bg-white/5 border border-white/10 flex items-center justify-center"
                                        initial={{ scale: 0 }}
                                        animate={{ scale: 1 }}
